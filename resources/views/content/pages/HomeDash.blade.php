...
@section('content')
    ...
    <div class="row">
        <div class="bg-image" style="background-image: url('{{ asset('assets/img/dash1.jpg') }}');">
            <section class="py-4">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTabJustified" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="contact" aria-selected="false">Ansi-x12</button>
                                        </li>
                                    </ul>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab"
                                                                ...
                                                                <button class="nav-link" id="v-pills-messages-tab"
                                                                    ...
                                                                    aria-selected="false">Electronic Data
                                                                    Interchange</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                ...
                                                                <div class="tab-pane fade" id="v-pills-messages"
                                                                    ...
                                                                    <div class="card">
                                                                        <img src="{{ asset('assets/img/ediprocess.png') }}"
                                                                            class="card-img-top" alt="...">
                                                                        <div class="card-body">
                                                                            <h5 class="card-title"><strong>What
                                                                                    is
                                                                                    Electronic Data
                                                                                    Interchange?</strong></h5>
                                                                            <p class="card-text">Electronic
                                                                                Data
                                                                                ...
                                                                                notices,
                                                                                and
                                                                                more. Instead of relying on
                                                                                paper-based documents that are
                                                                                prone
                                                                                to
                                                                                errors,
                                                                                ...
                                                                                exchange
                                                                                of
                                                                                structured data directly between
                                                                                computer systems.</p>
                                                                        </div>
                                                                    </div><!-- End Card -->
                                                                </div>
